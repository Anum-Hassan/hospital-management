...
$route['doctor'] = 'users/ourDoctor';
$route['services'] = 'users/services';
$route['features'] = 'users/features';
$route['contact'] = 'users/contacts';
$route['appointment'] = 'users/Appointments';
$route['appointment_history'] = 'users/appointment_history';
